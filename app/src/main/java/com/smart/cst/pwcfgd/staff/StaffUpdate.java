...
public class StaffUpdate extends AppCompatActivity implements Imageutils.ImageAttachmentListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        staffId = sharedpreferences.getString(staffIdKey, "");
            ...
            public void onClick(View v) {
                if (name.getText().toString().length() > 0 &&
                    ...
                    if (!password.getText().toString().equalsIgnoreCase(confirmPass.getText().toString())) {
                        ...
                        Staff staffTemp = new Staff(name.getText().toString(),
                                ...
                                confirmPass.getText().toString(), imageUrl, staff == null || staff.getRegid() == null ? null : staff.getRegid());

                        registerUser(new Gson().toJson(staffTemp));
                    }
                }
            }
        });
        ...
        try {
            staff = new Gson().fromJson(dbStaff.getDataBystaffid(staffId).get(1), Staff.class);
            name.setText(staff.name);
            contact.setText(staff.contact);
            address.setText(staff.address);
           ...
           // department.setText(staff.department);
            ...
            Toast.makeText(getApplicationContext(), "No Staff found", Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        dbStaff.updatedataBystaffid(staffId, mData);
