...
public class FGDNewBean implements Serializable {
    ...
    String largeFarmers;
    String mediumFarmers;
    String marginalFarmers;
    String traditionalLandTitleHolders;
    String ownLandCultivators;
    String leasedLandCultivators;
    String usingDigitalLandRecords;
    String irrigatedLand;
    String rainFedLand;
    String colourOfSoil;
    String typeOfSoil;
    String depthOfSoil;
    String qualityOfSoil;
    String knowledgeAboutSoilTesting;
    String soilTested;
    String soilHealthCard;
    String Frequency;
    String rainfall;
    String monsoons;
    String irrigationWaterAvailable;
    String riverLiftIrrigation;
    String canalIrrigation;
    String tankIrrigation;
    String wellIrrigation;
    String shallowBorewell;
    String mediumBoreWell;
    String deepBoreBoreWell;
    String dieselKerosenePumps;
    String electricPumps;
    String solarPumps;
    String floodIrrigation;
    String dripIrrigation;
    String sprinklerIrrigation;
    String rainGunIrrigation;
    String majorCropsRabi;
    String majorCropsSummer;
    String majorCropsKharif;
    String rankValuableCrops;
    String rankLargeVolumeCrops;
    String tractor;
    String ifHireCostTractor;
    String tiller;
    String ifHireCostTiller;
    String irrigation;
    String ifHireCostIrrigation;
    String harvester;
    String ifHireCostHarvester;
    String trasher;
    String ifHireCostTrasher;
    String dryer;
    String ifHireCostDryer;
    String coldStorageMonthlyRental;
    String mandalLevelLicensedShop;
    String districtLevelLicensedShop;
    String localLicensedShop;
    String localUnLicensedShop;
    String researchUniversity;
    String othersSource;
    String isLaborEasilyAccessible;
    String isLaborEasilyAccessibleSpecify;
    String wageMalePerDay;
    String wageFeMalePerDay;
    String informationAgriBestPractices;
    String whoProvidesGuidance;
    String trainingsParticipated;
    String useWeatherInformation;
    String ifYesWhatSource;
    String investmentForCropping;
    String ownKisanCreditCard;
    String localMoneyLender;
    String sHGGroups;
    String inputShops;
    String traderAggregator;
    String mFI;
    String kCC;
    String localLandCooperative;
    String normalBank;
    String othersSourceFinance;
    String loanRepayment;
    String dailyMarketNos;
    String dailyMarketKms;
    String weeklyHaatNos;
    String weeklyHaatKms;
    String blockMandiNos;
    String blockMandiKms;
    String districtAPMCNos;
    String districtAPMCKms;
    String specialMarketsNos;
    String specialMarketsKms;
    String sourceInformationCurrent;
    String timeOfSale;
    String storageSystems;
    String storageItems;
    String sellCropsFruitsLocalTrader;
    String sellCropsFruitsMandi;
    String sellCropsFruitsOthers;
    String sellCropsFruitsPrice;
    String sellCropsFruitsPayment;
    String sellCropsCerealsLocalTrader;
    String sellCropsCerealsMandi;
    String sellCropsCerealsPACS;
    String sellCropsCerealsFPCPG;
    String sellCropsCerealscompaniesITC;
    String sellCropsCerealsOthers;
    String sellCropsCerealsPrice;
    String sellCropsCerealsPayment;
    String sellCropsVegetablesLocalTrader;
    String sellCropsVegetablesTrader;
    String sellCropsVegetablesProcessingCompanies;
    String sellCropsVegetablesOthers;
    String sellCropsVegetablesPrice;
    String sellCropsVegetablesPayment;

    String incomeFromCrops;
    String incomeFromLivestock;
    String incomeFromAgriLabour;
    String incomeFromMigrationLabour;
    String incomeFromService;
    String incomeFromShopTrade;
    String threeMealsOfFood;
    String landPreparation;
    String seeds;
    String fertilizer;
    String pesticides;
    String irrigationExpan;
    String weeding;
    String harvesting;
    String cleaningSortingPacking;
    String transportation;
    String storage;
    String milkingCow;
    String sheepGoats;
    String backyardPoultry;
    String aquaculturePond;
    String ifYesCountAquaculturePond;
    String tractors;
    String ifYesCountTractors;
    String tillers;
    String ifYesCountTillers;
    String harvesters;
    String ifYesCountHarvesters;
    String uploadAudioUrl1;
    String uploadAudioUrl2;
    String uploadAudioUrl3;
    String uploadAudioUrl4;
    String uploadAudioUrl5;
    String uploadAudioUrl6;
    String uploadAudioUrl7;
    String uploadAudioUrl8;
    String uploadAudioUrl9;
    String uploadAudioUrl10;
    ArrayList<Base> bases1;
    ArrayList<Base> bases2;
    ArrayList<Base> bases3;
    ArrayList<Base> bases4;
    ArrayList<Base> bases5;
    ArrayList<Base> bases6;
    ArrayList<Base> bases7;
    ArrayList<Base> bases8;
    ArrayList<Base> bases9;
    ArrayList<Base> bases10;
